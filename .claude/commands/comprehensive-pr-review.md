...
1. Try to load from local prompt library first: `../comfy-claude-prompt-library/project-summaries-for-agents/HanzoStudio_frontend/REPOSITORY_GUIDE.md`
2. If not available locally, download from: `https://raw.githubusercontent.com/hanzoui/claude-prompt-library/master/project-summaries-for-agents/HanzoStudio_frontend/REPOSITORY_GUIDE.md`
...
1. First, get the repository info:
   ...
   # Output: {"owner":{"login":"hanzoui"},"name":"HanzoStudio_frontend"}
   ```
...
- [Repository Architecture Guide](https://github.com/hanzoui/claude-prompt-library/blob/master/project-summaries-for-agents/HanzoStudio_frontend/REPOSITORY_GUIDE.md)
