# Comprehensive PR Review for Hanzo Frontend
...
1. Try to load from local prompt library first: `../comfy-claude-prompt-library/project-summaries-for-agents/Hanzo Studio_frontend/REPOSITORY_GUIDE.md`
2. If not available locally, download from: `https://raw.githubusercontent.com/hanzoui/claude-prompt-library/master/project-summaries-for-agents/Hanzo Studio_frontend/REPOSITORY_GUIDE.md`
...
1. Use GitHub API to discover available knowledge folders: `https://api.github.com/repos/hanzoui/claude-prompt-library/contents/.claude/knowledge`
...
1. Use GitHub API: `https://api.github.com/repos/hanzoui/claude-prompt-library/contents/.claude/commands/validation`
...
1. First, get the repository info:
   ...
   # Output: {"owner":{"login":"hanzoui"},"name":"Hanzo Studio_frontend"}
   ```
...
gh api --method POST -H "Accept: application/vnd.github+json" -H "X-GitHub-Api-Version: 2022-11-28" /repos/hanzoui/frontend/pulls/$PR_NUMBER/comments -f body="$COMMENT_BODY" -f commit_id="abc123def456" -f path="src/db/queries.js" -F line=42 -f side="RIGHT"
...
- [Repository Architecture Guide](https://github.com/hanzoui/claude-prompt-library/blob/master/project-summaries-for-agents/Hanzo Studio_frontend/REPOSITORY_GUIDE.md)
- [Frontend Standards](https://github.com/hanzoui/claude-prompt-library/blob/master/.claude/commands/validation/frontend-code-standards.md)
- [Security Guidelines](https://github.com/hanzoui/claude-prompt-library/blob/master/.claude/commands/validation/security-audit.md)
